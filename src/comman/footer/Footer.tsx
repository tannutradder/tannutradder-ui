            ...
            <div className='p-3 py-5'>
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <div className='mt-2' style={{ height: '80px', width: '80px' }}>
                            <Link className='mx-1 d-flex flex-row align-items-center' to={"https://gyricu.on-app.in/app/home?orgCode=gyricu&referrer=utm_source=copy-link&utm_medium=tutor-app-referral"} target="_blank">
                                <img className='img img-fluid' src="playstore-svgrepo-com.svg" alt="" />
                                <p className='text-nowrap fs-1'>Install App</p>
                            </Link>
                        </div>
                    </div>
                </div>
